...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mnaveednoorani\033[1;91m...............
...
\033[1;95m☞ Facebook    : https://www.facebook.com/profile.php?id=100070191281226
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Naveed_Noorani Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Naveed Noorani WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/naveednoorani)
	    os.system('cd $HOME && git clone https://github.com/Naveed1112/naveednoorani')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Naveed_Noorani')
	    psb('Congratulations Naveed_NooraniTool Has Been Updated Successfully')
	    psb('🔓User Name☆ naveed✓')
	    psb('🔓Password ☆ noorani✓')
	    psb('Follow My id Naveed_Noorani✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/naveednoorani && python2 Naveed.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsapp.com/dl/03116072958')
	    menu()
	elif bm =='4':
